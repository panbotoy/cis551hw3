...
public class ClientMessageHandler {
	...
	private int serversequencenumber = 0; //always keep last server's sequence number
	private int clientsequencenumber = 0; //always keep current clients's sequence number
